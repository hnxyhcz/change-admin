...
public class TestBookSearchApi {
    ...
    private void testPublishDateFilter() throws Exception {
        ...
        query        =
            SearchBooksQuery.builder().publishDateStart(LocalDate.of(1985, 5, 1))
                .publishDateEnd(LocalDate.of(1985, 9, 1))
                .build();
        bookViewList = execute("/api/book/search", query);
        assertEquals(1, bookViewList.items().size(), "Invalid search result!");
        ...
        query        =
            SearchBooksQuery.builder().publishDateStart(LocalDate.of(1985, 8, 1))
                .publishDateEnd(LocalDate.of(1985, 9, 1))
                .build();
        bookViewList = execute("/api/book/search", query);
        assertEquals(0, bookViewList.items().size(), "Invalid search result!");
        ...
        query        =
            SearchBooksQuery.builder().publishDateStart(LocalDate.of(1985, 7, 17))
                .publishDateEnd(LocalDate.of(1985, 9, 1))
                .build();
        bookViewList = execute("/api/book/search", query);
        assertEquals(1, bookViewList.items().size(), "Invalid search result!");
        ...
        query        =
            SearchBooksQuery.builder().publishDateStart(LocalDate.of(1985, 5, 1))
                .publishDateEnd(LocalDate.of(1985, 7, 17))
                .build();
        bookViewList = execute("/api/book/search", query);
        assertEquals(0, bookViewList.items().size(), "Invalid search result!");
    }

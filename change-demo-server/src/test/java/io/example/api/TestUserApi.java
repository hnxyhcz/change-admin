...
public class TestUserApi {
    ...
    public void testCreateSuccess() throws Exception {
        ...
        MvcResult createResult = this.mockMvc
            .perform(
                post("/api/user").contentType(MediaType.APPLICATION_JSON).content(toJson(objectMapper, goodRequest)))
        ...
        assertEquals(goodRequest.fullName(), userView.getFullName(), "User fullname  update isn't applied!");
    }

    @Test
    public void testCreateFail() throws Exception {
        CreateUserRequest badRequest = new CreateUserRequest("invalid.username", "", "");

        this.mockMvc
            .perform(
                post("/api/user").contentType(MediaType.APPLICATION_JSON).content(toJson(objectMapper, badRequest)))
    ...
    public void testCreateUsernameExists() throws Exception {
        UserView userView =
            userTestDataFactory.createUser(String.format("test.user.%d@nix.io", currentTimeMillis()), "Test User A");

        CreateUserRequest badRequest = new CreateUserRequest(userView.getUsername(), "Test User A", "Test12345_");

        this.mockMvc
            .perform(
                post("/api/user").contentType(MediaType.APPLICATION_JSON).content(toJson(objectMapper, badRequest)))
            .andExpect(status().isBadRequest()).andExpect(content().string(containsString("Username exists")));
    }
    ...
    public void testCreatePasswordsMismatch() throws Exception {
        ...
        this.mockMvc
            .perform(
                post("/api/user").contentType(MediaType.APPLICATION_JSON).content(toJson(objectMapper, badRequest)))
            .andExpect(status().isBadRequest()).andExpect(content().string(containsString("Passwords don't match")));
    }
    ...
    public void testEditSuccess() throws Exception {
        ...
        assertEquals(updateRequest.fullName(), newUserView.getFullName(), "User fullname update isn't applied!");
    }
    ...
    public void testEditFailBadRequest() throws Exception {
        ...
        this.mockMvc
            .perform(put(String.format("/api/user/%s", userView.getId())).contentType(MediaType.APPLICATION_JSON)
    ...
    public void testEditFailNotFound() throws Exception {
        ...
        this.mockMvc
            .perform(put(String.format("/api/user/%s", "5f07c259ffb98843e36a2aa9"))
                .contentType(MediaType.APPLICATION_JSON).content(toJson(objectMapper, updateRequest)))
    ...
    public void testDeleteSuccess() throws Exception {
        ...
        this.mockMvc.perform(delete(String.format("/api/user/%s", userView.getId()))).andExpect(status().isOk());

        this.mockMvc.perform(get(String.format("/api/user/%s", userView.getId()))).andExpect(status().isNotFound());
    }

    @Test
    public void testDeleteFailNotFound() throws Exception {
        this.mockMvc.perform(delete(String.format("/api/user/%s", "5f07c259ffb98843e36a2aa9")))
            .andExpect(status().isNotFound())
            .andExpect(content().string(containsString("Entity User with id 5f07c259ffb98843e36a2aa9 not found")));
    }
    ...
    public void testDeleteAndCreateAgain() throws Exception {
        ...
        CreateUserRequest goodRequest = new CreateUserRequest(userView.getUsername(), "Test User A", "Test12345_");
    ...
    public void testGetSuccess() throws Exception {
        ...
        MvcResult getResult = this.mockMvc.perform(get(String.format("/api/user/%s", userView.getId())))
            .andExpect(status().isOk()).andReturn();
    ...
    public void testGetNotFound() throws Exception {
        this.mockMvc.perform(get(String.format("/api/user/%s", "5f07c259ffb98843e36a2aa9")))
            .andExpect(status().isNotFound())
            .andExpect(content().string(containsString("Entity User with id 5f07c259ffb98843e36a2aa9 not found")));
    }

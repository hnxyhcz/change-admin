...
public class TestAuthorApi {
    ...
    public void testCreateSuccess() throws Exception {
        ...
        AuthorView authorView =
            fromJson(objectMapper, createResult.getResponse().getContentAsString(), AuthorView.class);
    ...
    public void testEditSuccess() throws Exception {
        ...
        EditAuthorRequest updateRequest =
            EditAuthorRequest.builder().fullName("Test Author B").about("Cool author").build();
    ...
    public void testGetSuccess() throws Exception {
        ...
        AuthorView newAuthorView =
            fromJson(objectMapper, getResult.getResponse().getContentAsString(), AuthorView.class);

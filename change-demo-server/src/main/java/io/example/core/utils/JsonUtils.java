...
import io.example.core.exception.JsonException;
...
/**
 * @author huang.cz
 * @since 2022/5/27 0:01
 */
@UtilityClass
public class JsonUtils {
    private final ObjectMapper objectMapper = ContextHelper.getBean(ObjectMapper.class);
    ...
    public <T> T jsonObject(String json, JavaType javaType) {
        return jsonToObject(json, javaType, objectMapper);
    }
    ...
    public <T> List<T> jsonToList(String json, Class<T> type) throws JsonException {
        return jsonToList(json, type, objectMapper);
    }
    ...
    public <T> List<T> jsonToList2(String json, Class<T> type) throws IOException {
        return jsonToList2(json, type, objectMapper);
    }
